...
> FastHttpd and fasthttp are versioned independently. FastHttpd **v0.12.3** is built against fasthttp **v1.72.0**.
...
```sh
VERSION=0.12.3 GOOS=linux GOARCH=amd64; \

...
> FastHttpd and fasthttp are versioned independently. FastHttpd **v0.12.4** is built against fasthttp **v1.73.0**.
...
```sh
VERSION=0.12.4 GOOS=linux GOARCH=amd64; \

...
> FastHttpd and fasthttp are versioned independently. FastHttpd **v0.12.5** is built against fasthttp **v1.74.0**.
...
```sh
VERSION=0.12.5 GOOS=linux GOARCH=amd64; \
